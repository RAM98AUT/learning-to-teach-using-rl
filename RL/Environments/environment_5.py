...
class SkillEnv_5(Env):
    ...
    This environtment provides the agent with the number of correct/incorrect responses so far 
    Observation:
        Probabilities of all skills
    Reward: 
    ...
    def __init__(self,blocks,n_skills,n_exercises,exercise_types,l0,transition,slip,guess,reward=None):
        ...
        self.observation_space = Box(low=0.0, high=1.0,shape=(self.n_skills,))
    ...
    def step(self,action):
        ...
        ------------
        responses: (n_skills,)
                correct/wrong responses of the student till now
        reward: int
        ...
        return self.prob_state, reward, done, info
